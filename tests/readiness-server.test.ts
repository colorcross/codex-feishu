...
describe('metrics server readiness', () => {
  it('reports readiness state consistently across /healthz, /readyz, and /metrics', async () => {
    ...
    expect(metricsOutput.body).toContain('codex_feishu_service_ready 1');
    expect(metricsOutput.body).toContain('codex_feishu_service_live 1');
    expect(metricsOutput.body).toContain('codex_feishu_startup_warnings 1');
    expect(metricsOutput.body).toContain('codex_feishu_startup_errors 0');
  });
});
